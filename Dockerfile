...
RUN yum update -y \
&& yum install -y tar nano sudo nfs-utils-lib curl wget java-1.7.0-openjdk-devel cairo-devel libpng-devel tk-devel libicu libXt-devel readline readline-devel glibc-devel gcc gcc-gfortran gcc-c++ make ed
